...
# Set environment
ENV PYTHONUNBUFFERED=1     HOST=0.0.0.0     PORT=8788     API_KEY=qwer.1234     TZ=Asia/Shanghai
...
COPY wb_proxy.py wb_accounts.py wb_catalog.py wb_fingerprint.py wb_scheduler.py wb_tasks.py dashboard.html ./
