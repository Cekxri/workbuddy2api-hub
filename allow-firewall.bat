...
powershell -NoProfile -Command ^
  ...
  'name=WorkBuddy proxy (TCP %PORT%)','dir=in','action=allow','protocol=TCP','localport=%PORT%'"
...
echo   netsh advfirewall firewall delete rule name="WorkBuddy proxy (TCP %PORT%)"
echo.
pause
